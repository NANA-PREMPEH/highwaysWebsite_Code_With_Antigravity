...
def update_overlay(overlay_data):
    entries = []
    for contract in overlay_data["all contract"]:
        new_entry = Asphalticoverlay(name_of_contract=contract['name_of_contract'], length=contract['length'], lot=contract['lot'],
