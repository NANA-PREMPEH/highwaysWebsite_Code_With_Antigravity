...
def update_precons(precons_data):
    entries = []
    for contract in precons_data["all contract"]:
        new_entry = Preconstruction(name_of_contract=contract['name_of_contract'], length=contract['length'], lot=contract['lot'],
