...
def update_regrav(regrav_data):
    entries = []
    for contract in regrav_data["all contract"]:
        new_entry = Regravelling(name_of_contract=contract['name_of_contract'], length=contract['length'], lot=contract['lot'],
