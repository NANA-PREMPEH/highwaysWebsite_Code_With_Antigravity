...
def update_repairs(repairs_data):
    entries = []
    for contract in repairs_data["all contract"]:
        new_entry = Repairs(name_of_contract=contract['name_of_contract'], length=contract['length'], lot=contract['lot'],
