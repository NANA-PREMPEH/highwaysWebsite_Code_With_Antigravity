...
def update_reseal(reseal_data):
    entries = []
    for contract in reseal_data["all contract"]:
        new_entry = Resealing(name_of_contract=contract['name_of_contract'], length=contract['length'], lot=contract['lot'],
